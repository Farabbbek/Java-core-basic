...
public class javautilSort {
    ...
    public static void main(String[] args) {
        ...
        boolean isSame = Arrays.equals(playlistA, playlistB);

        if (isSame) {
            System.out.println("Both playlists contain the same songs.");
        } else {
            System.out.println("Playlists are different.");
        }
    }
}
